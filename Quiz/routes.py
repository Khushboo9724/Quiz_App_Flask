...
def register():
    try:
        if request.method == 'POST':
            ...
            url = 'http://d0dd-14-99-145-110.ngrok.io/register'
...
def login():
    ...
    if request.method == 'POST':
        ...
        url = 'http://d0dd-14-99-145-110.ngrok.io/login'
        response = requests.post(url=url, json=data)
        print(response)
...
def quiz():
    if session['logged_in'] == True:
        ...
        print("%&&%", data)
        response = requests.get(url='http://d0dd-14-99-145-110.ngrok.io/quiz', json=data)
...
def quiz_taken():
    ...
    try:
        if request.method == 'POST':
            ...
            url = 'http://d0dd-14-99-145-110.ngrok.io/taken_quiz'
...
@app.route("/result")
def result():
    response = requests.post(url='http://d0dd-14-99-145-110.ngrok.io/result')
...
def view_all_que():
    response = requests.post(url='http://d0dd-14-99-145-110.ngrok.io/view_que')
...
def add_que():
    try:
        ...
        if request.method == 'POST':
            ...
            url = 'http://d0dd-14-99-145-110.ngrok.io/add'
            response = requests.post(url=url, json=data)
...
def edit(id):
    try:
        data = {"id": id}
        url = 'http://d0dd-14-99-145-110.ngrok.io/edit'
        response = requests.post(url=url, json=data)
        qa_list = response.json()
...
def update():
    try:
        ...
        if request.method == 'POST':
            ...
            # print('%%%', pay_load)
            url = 'http://d0dd-14-99-145-110.ngrok.io/update'
            response = requests.post(url=url, json=pay_load)
...
def delete(id):
    data = {"id": id}
    response = requests.post(url='http://d0dd-14-99-145-110.ngrok.io/delete', json=data)
